...
2.37 Verify the text “Welcome to our store”
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        computerPage.sendText(computerPage.firstName, "Bhavesh");
        computerPage.sendText(computerPage.lastName, "Jani");
        computerPage.sendText(computerPage.emailId, "abc123@gmail.com");
        ...
        computerPage.sendText(computerPage.phoneNumber, "07234563457");
        ...
        computerPage.sendText(computerPage.cardHolderName, "Bhavesh jani");
        computerPage.sendText(computerPage.creditCardNumber, "5413338765410640");
        computerPage.select(computerPage.expiryYear, "2029");
        computerPage.sendText(computerPage.cardCVV, "777");
